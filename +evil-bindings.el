;;; ~/.doom.d/+evil-bindings.el -*- lexical-binding: t; -*-
...
(map!
  ...
  :desc "switch workspace" :nv "gT" #'+workspace/switch-to
...
(map! :leader
      ...
      (:prefix-map ("e" . "errors/emacs")
        "ee" #'+default/find-in-config
        "eE" #'+default/browse-config
        "ed" #'+default/find-in-emacsd
        "eD" #'+default/browse-emacsd
      ...
      (:prefix-map ("l" . "workspace/layout")
        ...
        :desc "rename workspace"                     "r"   #'+workspace/rename)
        ;; "lt" '(me/new-workspace-term "create a term-mode buffer for workspace")
        ;; :desc "toggle workspace"                     "TAB"   #'doom/jump-to
...
(map! :map json-mode-map
  :desc "xpath" :n ",xp" #'jsons-print-path
